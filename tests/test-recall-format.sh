...
# Docs should score HIGH
assert_contains "docs result is HIGH" "HIGH.*Official docs" "$context"

# GitHub with 15 likes + 7 votes should score HIGH
assert_contains "github high-engagement is HIGH" "HIGH.*GitHub issue" "$context"
...
# Low-engagement unsolved community should be LOW
assert_contains "low-engagement unsolved community is LOW" "LOW.*Community" "$context"
